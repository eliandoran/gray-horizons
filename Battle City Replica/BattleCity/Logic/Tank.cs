...
//                hasFirstMoved));
        ...
        {    
            MuzzlePosition.Rotation = TurrelRotation.ToRadians ();
            TurretRect.Rotation = TurrelRotation.ToRadians ();
            ...
            var rads = TurrelRotation.ToRadians ();
        ...
        public override void Render ()
        {
            ...
            GameData.SpriteBatch.Draw (
                ...
                origin: new Vector2 (tankRect.Width / 2, tankRect.Height / 2),
                rotation: TurrelRotation.ToRadians (),
                scale: GameData.Scale
            );
        }
    }
