...
namespace BattleCity.Logic
{
	...
	public class DamageInfo
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="BattleCity.Logic.DamageInfo"/> class with specific parameters.
		/// </summary>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="BattleCity.Logic.DamageInfo"/> class with 1 damage and no pass through.
		/// </summary>
		public DamageInfo (): this(1, false)
		{
