...
namespace BattleCity.UI
{
    ...
    public delegate void DeselectedEventHandler (object sender, EventArgs e);
    public delegate void ActivatedEventHandler (object sender, EventArgs e);

    public class MenuItem: GameScreen
    {
        public event SelectedEventHandler Select;
        public event DeselectedEventHandler Deselect;
        public event ActivatedEventHandler Activate;
